...
export async function deleteUserInterfaceInfoUsingPOST(
  ...
  return request<API.Resultboolean>('/api/userInterfaceInfo/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getUserInterfaceInfoByIdUsingGET(
  ...
  return request<API.ResultUserInterfaceInfo>('/api/userInterfaceInfo/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listUserInterfaceInfoUsingGET(
  ...
  return request<API.ResultListUserInterfaceInfo>('/api/userInterfaceInfo/list', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listUserInterfaceInfoByPageUsingGET(
  ...
  return request<API.ResultPageUserInterfaceInfo>('/api/userInterfaceInfo/list/page', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateUserInterfaceInfoUsingPOST(
  ...
  return request<API.Resultboolean>('/api/userInterfaceInfo/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
